...
class Animator {
    ...
    {
        var q1= glMatrix.quat.fromValues(RotationKeys[0].arr[1], -RotationKeys[0].arr[3], -RotationKeys[0].arr[2] ,RotationKeys[0].arr[0]);
        //glMatrix.quat.invert(q1, q1);
        ...
        var q2= glMatrix.quat.fromValues(RotationKeys[nextIndex].arr[0], RotationKeys[nextIndex].arr[1], RotationKeys[nextIndex].arr[2] ,RotationKeys[nextIndex].arr[3]);
